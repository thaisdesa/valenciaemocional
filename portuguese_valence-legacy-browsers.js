...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'scripts_1_2_3_ - Página1.csv', 'path': 'scripts_1_2_3_ - Página1.csv'},
    {'name': 'scripts_1_2_3_ - Página1.csv', 'path': 'scripts_1_2_3_ - Página1.csv'},
  ]
});
...
async function experimentInit() {
  ...
  instructions_text = new visual.TextStim({
    ...
    text: 'Instruções\n\n\nNa tela seguinte você verá uma palavra e deverá julgá-la na escala de acordo com a forma que você se sente, sendo 01 o mais negativo e 9 o mais positivo.\n\n\nPressione ESPAÇO para continuar.',
    font: 'Open Sans',
    units: undefined, 
  ...
  slider = new visual.Slider({
    ...
    labels: ["1- Muito Negativo", "2", "3", "4", "5", "6", "7", "8", "9- Muito Positivo"], fontSize: 25.0, ticks: [1, 2, 3, 4, 5, 6, 7, 8, 9],
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      trialList: TrialHandler.importConditions(psychoJS.serverManager, 'scripts_1_2_3_ - Página1.csv', minhas_linhas),
